            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                <div className="w-5 h-5 mt-0.5">
                  <svg fill="currentColor" viewBox="0 0 20 20" className="text-brand-gold">
                    <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd"/>
                  </svg>
                </div>
                <p className="text-gray-400 text-sm">Abu Dhabi, UAE</p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-5 h-5 mt-0.5">
                  <svg fill="currentColor" viewBox="0 0 20 20" className="text-brand-gold">
                ...
                <p className="text-gray-400 text-sm">+971-54-7593444</p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-5 h-5 mt-0.5">
                  <svg fill="currentColor" viewBox="0 0 20 20" className="text-brand-gold">
                ...
                <p className="text-gray-400 text-sm">recruit@nmhruae.com</p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-5 h-5 mt-0.5">
                  <svg fill="currentColor" viewBox="0 0 20 20" className="text-brand-gold">
                ...
                <p className="text-gray-400 text-sm">www.nmhruae.com</p>
              </div>
            </div>
          </div>
        </div>
